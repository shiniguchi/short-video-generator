...
must_haves:
  truths:
    - "Pipeline executes all stages in sequence: trend collection, trend analysis, content generation (script + video + voiceover), composition, review"
  ...
  artifacts:
    ...
    - path: "app/tasks.py"
      provides: "Existing stage tasks remain unchanged"
  key_links:
